...
class Dialog(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.groups = self.game.dialog
        pygame.sprite.Sprite.__init__(self, self.groups)

        self.x = x * TEXTBOXSIZE2
        self.y = y * TEXTBOXSIZE
        self.width = TEXTBOXSIZE2
        self.height = TEXTBOXSIZE
                    
        self.image = self.game.dialog.get_sprite(0, 0, self.width, self.height)
