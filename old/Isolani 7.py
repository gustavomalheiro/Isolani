...
class Game:
    def __init__(self):
        ...
        self.dialog_spritesheet = Spritesheet('img/dialog.png')
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_s:
                    Dialog(self, 0, 576, WHITE, 'Isolani... É você?', 32)
    ...
    def game_over(self):
        ...
        restart_button = Button(10, screen_height - 60, 120, 50, WHITE, BLUE, 'Restart', 32)
...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        #self.rect = pygame.Rect(self.y, self.x, 64, 72)
        ...
        self.wakeup_animations = [self.game.character_spritesheet.get_sprite(0, 576, self.width, self.height),
                           ...
                           self.game.character_spritesheet.get_sprite(0, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(64, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(128, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(192, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(256, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(320, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(384, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(448, 720, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(0, 864, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(64, 864, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(128, 864, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(192, 864, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(256, 864, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(320, 864, self.width, self.height),]
...
class Dialog(pygame.sprite.Sprite):
    def __init__(self, game, x, y, fg, content, fontsize):
        ...
        self.groups = self.game.all_sprites, self.game.dialog, self.game.text
        pygame.sprite.Sprite.__init__(self, self.groups)
        self.x = x
        self.y = y
        self. width = TEXTBOXSIZE
        self.height = TEXTBOXSIZE2
        self.image = self.game.dialog_spritesheet.get_sprite(0, 0, self.width, self.height)
        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y
...
class Tutorial(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.tutorial1_animations = [self.game.tutorial_spritesheet.get_sprite(0, 128, self.width, self.height),
                           self.game.tutorial_spritesheet.get_sprite(128, 128, self.width, self.height),
                           self.game.tutorial_spritesheet.get_sprite(256, 128, self.width, self.height),
                           ]

        self.tutorial2_animations = [self.game.tutorial_spritesheet.get_sprite(0, 0, self.width, self.height),
                           self.game.tutorial_spritesheet.get_sprite(128, 0, self.width, self.height),
                           self.game.tutorial_spritesheet.get_sprite(256, 0, self.width, self.height),
                           ]
